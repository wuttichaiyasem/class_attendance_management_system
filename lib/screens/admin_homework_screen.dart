import 'package:class_attendance_management_system/screens/admin_homework_details_screen.dart';
...
class AdminHomeworkScreen extends StatefulWidget {
  @override
  State<AdminHomeworkScreen> createState() => _AdminHomeworkScreenState();
}
...
class _AdminHomeworkScreenState extends State<AdminHomeworkScreen> {
  ...
  Future<void> _fetchSubjects() async {
    try {
      ...
      final data = await AdminHomeworkService.fetchSubjects(token);
      print(data);
      setState(() {
